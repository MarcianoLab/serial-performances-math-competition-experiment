(() => {
  ...
  function buildRuntimeConfig(baseConfig) {
    ...
    runtimeConfig.PRACTICE_TRIAL_COUNT = clampInteger(runtimeConfig.PRACTICE_TRIAL_COUNT, 0, 100);
    ...
    runtimeConfig.COUNTDOWN_WARNING_SECONDS = clampInteger(
      ...
      1,
      runtimeConfig.WORK_PERIOD_SECONDS
    );
  ...
  function getPublicConfig() {
    return {
      ...
      practiceEnabled: config.ENABLE_PRACTICE_BLOCK,
      practiceTrialCount: config.PRACTICE_TRIAL_COUNT,
